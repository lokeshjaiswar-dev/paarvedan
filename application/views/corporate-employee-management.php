...
<body data-mobile-nav-style="classic">
    ...
    <section class="page-title-separate-breadcrumbs bg-dark-gray ipad-top-space-margin cover-background bg-dark-gray"
        style="background-image: url(<?= base_url('assets/image/corporate2.png')?>)">
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-6 md-mb-50px animation-float text-center" data-anime='{ "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
                    <img src="<?= base_url('assets/image/corporate.jpg')?>" alt="">
                </div>
                    ...
                    <div class="contact-form-style-01" data-anime='{ "translateX": [0, 0], "opacity": [0,1], "duration": 600, "delay": 300, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        ...
                        <form action="#" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="position-relative form-group mb-20px">
                                        ...
                                        <input type="text" name="Corporatename" class="form-control required" placeholder="Corporate Name*">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="position-relative form-group mb-20px">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="position-relative form-group mb-20px">
                                        ...
                                        <select name="fieldIndustry" class="form-control required">
                                ...
                                <div class="col-lg-6">
                                    <div class="position-relative form-group mb-20px">
                                        ...
                                        <input type="number" name="noe" class="form-control required" placeholder="Number of Employees*">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="position-relative form-group form-textarea mb-20px">
                                ...
                                <textarea placeholder="Briefly outline the goals and objectives..." name="collabObj" class="form-control required" rows="4"></textarea>
                            </div>
                            ...
                            <div class="position-relative form-group form-textarea mb-20px">
                                ...
                                <textarea placeholder="Describe the current or planned employee welfare initiatives..." name="ewi" class="form-control" rows="4"></textarea>
                            </div>
                            ...
                            <div class="position-relative mt-20px">
                                <button class="btn btn-large btn-round-edge btn-base-color btn-box-shadow submit" type="submit">Submit</button>
