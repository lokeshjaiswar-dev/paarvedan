...
<body data-mobile-nav-style="classic">
    ...
    <section class="page-title-separate-breadcrumbs bg-dark-gray background-position-center-top ipad-top-space-margin cover-background bg-dark-gray"
        style="background-image: url(<?= base_url('assets/image/18.jpg') ?>)">
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-6 md-mb-50px animation-float text-center" data-anime='{ "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
                    <img src="<?= base_url('assets/image/data.jpg') ?>" alt="">
                </div>
            ...
            <div class="col-12 text-center mb-5">
                <div class="image-box mx-auto" style="max-width: 400px;">
                    ...
                    <figure class="image image-1">
                        <img loading="lazy" src="<?= base_url('assets/image/aboutintro.png') ?>" alt="Mr. Arun Chouhan & Ms. Bindubala Chouhan" class="img-fluid rounded-3 shadow-lg" style="width: 100%; height: auto;" />
                    </figure>
                            ...
                            <div class="col-lg-4 col-md-12 col-sm-12 image-column mb-4 mb-lg-0">
                                <div class="image-box">
                                    <figure class="image history-images shadow-lg rounded-3 overflow-hidden">
                                        <img loading="lazy" src="<?= base_url('assets/image/aboutoneimage.png') ?>" alt="Mr. Bhagirth Ji Rupchand Chouhan" class="img-fluid w-100" />
                                    </figure>
                    ...
                    <div class="inner-container">
                        <div class="row clearfix align-items-start">
                            ...
                            <div class="col-lg-4 col-md-12 col-sm-12 image-column mb-4 mb-lg-0">
                                <div class="image-box">
                                    <figure class="image history-images shadow-lg rounded-3 overflow-hidden">
                                        <img loading="lazy" src="<?= base_url('assets/image/abouttwo.png') ?>" alt="Mr. Ramgopal Ji Bhagirth Chouhan" class="img-fluid w-100" />
                                    </figure>
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-6 md-mb-50px animation-float text-center order-lg-2">
                    <img src="<?= base_url('assets/image/aboutusfew.jpg') ?>" alt="">
                </div>
    ...
    <div class="row gy-4">
      <div class="col-6 col-md-4 col-xl-3 text-center">
        <div class="text-secondary bg-light px-4 py-3 px-md-6 py-md-4 px-lg-8 py-lg-5">
         <img src="<?= base_url('assets/image/brand/hdfc.jpeg') ?>"/>
      ...
      <div class="col-6 col-md-4 col-xl-3 text-center">
        <div class="text-secondary bg-light px-4 py-3 px-md-6 py-md-4 px-lg-8 py-lg-5">
          <img src="<?= base_url('assets/image/brand/mahindra.png') ?>"/>
      ...
      <div class="col-6 col-md-4 col-xl-3 text-center">
        <div class="text-secondary bg-light px-4 py-3 px-md-6 py-md-4 px-lg-8 py-lg-5">
          <img src="<?= base_url('assets/image/brand/reliance.png') ?>"/>
      ...
      <div class="col-6 col-md-4 col-xl-3 text-center">
        <div class="text-secondary bg-light px-4 py-3 px-md-6 py-md-4 px-lg-8 py-lg-5">
          <img src="<?= base_url('assets/image/brand/muso.png') ?>"/>
      ...
      <div class="col-6 col-md-4 col-xl-3 text-center">
        <div class="text-secondary bg-light px-4 py-3 px-md-6 py-md-4 px-lg-8 py-lg-5">
          <img src="<?= base_url('assets/image/brand/paarvedan.png') ?>"/>
      ...
      <div class="col-6 col-md-4 col-xl-3 text-center">
        <div class="text-secondary bg-light px-4 py-3 px-md-6 py-md-4 px-lg-8 py-lg-5">
          <img src="<?= base_url('assets/image/brand/ram roti.png') ?>"/>
      ...
      <div class="col-6 col-md-4 col-xl-3 text-center">
        <div class="text-secondary bg-light px-4 py-3 px-md-6 py-md-4 px-lg-8 py-lg-5">
          <img src="<?= base_url('assets/image/brand/redchillies.png') ?>"/>
      ...
      <div class="col-6 col-md-4 col-xl-3 text-center">
        <div class="text-secondary bg-light px-4 py-3 px-md-6 py-md-4 px-lg-8 py-lg-5">
          <img src="<?= base_url('assets/image/brand/bookwallah.png') ?>"/>
        ...
        <div class="position-relative">
            ...
            <div class="d-flex overflow-auto pb-3 gap-4 custom-scrollbar team-scroll-container" id="team-grid-scroll"> 
                ...
                <div class="team-col flex-shrink-0" style="width: 280px;">
                    <div class="card team-card h-100 border-0 shadow-sm overflow-hidden">
                        <figure class="image-box position-relative overflow-hidden">
                            ...
                            <img loading="lazy" src="<?= base_url('assets/image/treamdummy.png') ?>" alt="Arun Chouhan - Founder" class="img-fluid w-100 team-image">
                        </figure>
                ...
                <div class="team-col flex-shrink-0" style="width: 280px;">
                    <div class="card team-card h-100 border-0 shadow-sm overflow-hidden">
                        <figure class="image-box position-relative overflow-hidden">
                            <img loading="lazy" src="<?= base_url('assets/image/treamdummy.png') ?>" alt="Bindubala Chouhan - Team Member" class="img-fluid w-100 team-image">
                        </figure>
                        <div class="card-body text-center p-3">
                ...
                <div class="team-col flex-shrink-0" style="width: 280px;">
                    <div class="card team-card h-100 border-0 shadow-sm overflow-hidden">
                        <figure class="image-box position-relative overflow-hidden">
                            <img loading="lazy" src="<?= base_url('assets/image/treamdummy.png') ?>" alt="Salmen Khan - Team Member" class="img-fluid w-100 team-image">
                        </figure>
                        <div class="card-body text-center p-3">
                            <span class="designation text-muted d-block mb-1 fs-6">Team Member</span>
                ...
                <div class="team-col flex-shrink-0" style="width: 280px;">
                    <div class="card team-card h-100 border-0 shadow-sm overflow-hidden">
                        <figure class="image-box position-relative overflow-hidden">
                            <img loading="lazy" src="<?= base_url('assets/image/treamdummy.png') ?>" alt="Mayur Gita - Team Member" class="img-fluid w-100 team-image">
                        </figure>
                        <div class="card-body text-center p-3">
                            <span class="designation text-muted d-block mb-1 fs-6">Team Member</span>
                ...
                <div class="team-col flex-shrink-0" style="width: 280px;">
                    <div class="card team-card h-100 border-0 shadow-sm overflow-hidden">
                        <figure class="image-box position-relative overflow-hidden">
                            <img loading="lazy" src="<?= base_url('assets/image/treamdummy.png') ?>" alt="Anita Rana - Team Member" class="img-fluid w-100 team-image">
                        </figure>
                        <div class="card-body text-center p-3">
                            <span class="designation text-muted d-block mb-1 fs-6">Team Member</span>
                ...
                <div class="team-col flex-shrink-0" style="width: 280px;">
                    <div class="card team-card h-100 border-0 shadow-sm overflow-hidden">
                        <figure class="image-box position-relative overflow-hidden">
                            <img loading="lazy" src="<?= base_url('assets/image/treamdummy.png') ?>" alt="Ashish Jain - Team Member" class="img-fluid w-100 team-image">
                        </figure>
                        <div class="card-body text-center p-3">
                            <span class="designation text-muted d-block mb-1 fs-6">Team Member</span>
                ...
                <div class="team-col flex-shrink-0" style="width: 280px;">
                    <div class="card team-card h-100 border-0 shadow-sm overflow-hidden">
                        <figure class="image-box position-relative overflow-hidden">
                            <img loading="lazy" src="<?= base_url('assets/image/treamdummy.png') ?>" alt="Talha Choudhary - Team Member" class="img-fluid w-100 team-image">
                        </figure>
                        <div class="card-body text-center p-3">
                            <span class="designation text-muted d-block mb-1 fs-6">Team Member</span>
                ...
                <div class="team-col flex-shrink-0" style="width: 280px;">
                    <div class="card team-card h-100 border-0 shadow-sm overflow-hidden">
                        <figure class="image-box position-relative overflow-hidden">
                            <img loading="lazy" src="<?= base_url('assets/image/treamdummy.png') ?>" alt="Saqib Ghatte - Team Member" class="img-fluid w-100 team-image">
                        </figure>
                        <div class="card-body text-center p-3">
                            <span class="designation text-muted d-block mb-1 fs-6">Team Member</span>
